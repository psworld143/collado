...
(11, 'aaaa', 'aaa', 'uploads/coffins/68260af95f49e.jpg', 12344.00, NULL, 10, '2025-05-15 15:40:41', '2025-05-15 17:26:25', 'wooden', 2, 5);
...
INSERT INTO `orders` (`id`, `user_id`, `contact_number`, `delivery_address`, `coffin_id`, `order_number`, `quantity`, `total_amount`, `status`, `is_paid`, `delivery_date`, `notes`, `created_at`, `updated_at`, `payment_status`, `delivery_status`) VALUES
(9, 3, '09123456789', 'Sample', 11, 'ORD-20250515-7871', 1, 12344.00, 'pending', 0, '2025-05-24', 'Sample', '2025-05-15 17:26:25', '2025-05-15 17:36:24', 'paid', 'pending');
...
CREATE TABLE `payments` (
  ...
  `status` enum('pending','completed','failed','refunded','paid','cancelled') DEFAULT 'pending',
...
INSERT INTO `payments` (`id`, `order_id`, `amount`, `payment_method`, `transaction_id`, `status`, `payment_date`, `notes`) VALUES
(4, 9, 12344.00, 'bank_transfer', 'ABC12345', 'pending', '2025-05-15 17:26:25', NULL);
...
(2, 11, 0, 5, 5, '', '2025-05-15 15:56:08', 4),
(3, 11, 5, 5, 10, '', '2025-05-15 16:10:19', 4);
...
(3, 'John Doe', 'johndoe@gmail.com', '$2y$10$vGQtyN95wmExCK5hpWa8KOYz0hNQM2ehH4hJsy0TSv7.KjdtBgFgW', 'user', '2025-05-08 14:03:19', '2025-05-15 17:20:54', '2025-05-15 17:20:54', NULL),
(4, 'Admin User', 'admin@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', '2025-05-08 14:36:28', '2025-05-15 17:27:58', '2025-05-15 17:27:58', NULL),
